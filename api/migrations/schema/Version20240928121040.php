...
final class Version20240928121040 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('ALTER TABLE checklistnode_checklistitem ADD CONSTRAINT FK_5A2B5B318A09A289 FOREIGN KEY (checklistitem_id) REFERENCES checklist_item (id) ON DELETE RESTRICT');
    }
