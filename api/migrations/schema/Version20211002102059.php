...
final class Version20211002102059 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('ALTER TABLE abstract_content_node_owner ADD CONSTRAINT FK_8E710AB4F886581C FOREIGN KEY (rootContentNodeId) REFERENCES content_node (id) ');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A6D299429 FOREIGN KEY (campId) REFERENCES camp (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A9C370B71 FOREIGN KEY (categoryId) REFERENCES category (id) ');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095ABF396750 FOREIGN KEY (id) REFERENCES abstract_content_node_owner (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE activity_responsible ADD CONSTRAINT FK_99684FE41335E2FC FOREIGN KEY (activityId) REFERENCES activity (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE activity_responsible ADD CONSTRAINT FK_99684FE456778C5C FOREIGN KEY (campCollaborationId) REFERENCES camp_collaboration (id) ');
        $this->addSql('ALTER TABLE camp ADD CONSTRAINT FK_C194423024B2CCF6 FOREIGN KEY (creatorId) REFERENCES "user" (id) ');
        $this->addSql('ALTER TABLE camp ADD CONSTRAINT FK_C1944230E05EFD25 FOREIGN KEY (ownerId) REFERENCES "user" (id) ');
        $this->addSql('ALTER TABLE camp_collaboration ADD CONSTRAINT FK_C93898A64B64DCC FOREIGN KEY (userId) REFERENCES "user" (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE camp_collaboration ADD CONSTRAINT FK_C93898A6D299429 FOREIGN KEY (campId) REFERENCES camp (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C16D299429 FOREIGN KEY (campId) REFERENCES camp (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1BF396750 FOREIGN KEY (id) REFERENCES abstract_content_node_owner (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE category_contenttype ADD CONSTRAINT FK_C3C55A4D12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ');
        $this->addSql('ALTER TABLE category_contenttype ADD CONSTRAINT FK_C3C55A4D54491BBC FOREIGN KEY (contenttype_id) REFERENCES content_type (id) ');
        $this->addSql('ALTER TABLE content_node ADD CONSTRAINT FK_481D0580B7939B21 FOREIGN KEY (rootId) REFERENCES content_node (id) ');
        $this->addSql('ALTER TABLE content_node ADD CONSTRAINT FK_481D058010EE4CEE FOREIGN KEY (parentId) REFERENCES content_node (id) ');
        $this->addSql('ALTER TABLE content_node ADD CONSTRAINT FK_481D0580FDA329E8 FOREIGN KEY (contentTypeId) REFERENCES content_type (id) ');
        ...
        $this->addSql('ALTER TABLE day ADD CONSTRAINT FK_E5A0299085CB41E9 FOREIGN KEY (periodId) REFERENCES period (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE day_responsible ADD CONSTRAINT FK_81AC6A2D194EB424 FOREIGN KEY (dayId) REFERENCES day (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE day_responsible ADD CONSTRAINT FK_81AC6A2D56778C5C FOREIGN KEY (campCollaborationId) REFERENCES camp_collaboration (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE material_item ADD CONSTRAINT FK_4B73482BC0B3A0A9 FOREIGN KEY (materialListId) REFERENCES material_list (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE material_item ADD CONSTRAINT FK_4B73482B85CB41E9 FOREIGN KEY (periodId) REFERENCES period (id) ON DELETE CASCADE ');
        ...
        $this->addSql('ALTER TABLE material_list ADD CONSTRAINT FK_10A0952D6D299429 FOREIGN KEY (campId) REFERENCES camp (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE period ADD CONSTRAINT FK_C5B81ECE6D299429 FOREIGN KEY (campId) REFERENCES camp (id) ');
        $this->addSql('ALTER TABLE schedule_entry ADD CONSTRAINT FK_D7785D2C85CB41E9 FOREIGN KEY (periodId) REFERENCES period (id) ON DELETE CASCADE ');
        $this->addSql('ALTER TABLE schedule_entry ADD CONSTRAINT FK_D7785D2C1335E2FC FOREIGN KEY (activityId) REFERENCES activity (id) ON DELETE CASCADE ');
    }
