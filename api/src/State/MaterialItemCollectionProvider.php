...
class MaterialItemCollectionProvider implements ProviderInterface {
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): array|object|null {
        ...
        $hasSubresource = !empty($uriVariables) && (isset($uriVariables['campId']) || isset($uriVariables['materialListId']) || isset($uriVariables['materialNodeId'])); // ponytail: minimal guard change — check $uriVariables instead of only $request->query.
